...
h1, .author {
  color: #6633ff !important; /* Tutaj wpisz swój kolor nagłówka (teraz biały) */
}

/* Stylizacja przycisków/linków pod zdjęciem */
.btn-outline-dark {
  color: #6633ff !important;        /* Kolor tekstu na przyciskach */
  border-color: #6633ff !important; /* Kolor ramki przycisków */
...
.col-lg-8 {
  ...
  border-radius: 10px;
  color: #6633ff !important; /* Jasnoszary kolor głównej czcionki */
}
