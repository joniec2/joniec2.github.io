...
/* 2. Usunięcie białego tła z kontenerów, aby nasze tło było widoczne */
.container-fluid, 
.row, 
.col-md-6, 
.col-lg-4, 
...
/* 3. Opcjonalnie: lekko przyciemnione/rozjaśnione tło pod samym tekstem, */
/* żeby napisy były czytelne na tle obrazka */
.col-lg-8 {
  background: rgba(255, 255, 255, 0.85) !important; /* białe tło z 85% widocznością */
