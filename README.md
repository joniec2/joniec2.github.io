...
This repository contains my **digital CV**, created in **HTML** with a clean and elegant design using custom CSS.  
The project was built to be **clear, responsive, and easy to update** — both locally and online.

---

## ✨ About the Project

🔹 **Goal:** Present my professional experience, skills, and projects in a modern, interactive format  
🔹 **Technologies:** HTML5, CSS3 *(optionally: Quarto)*  
🔹 **Format:** Single-page CV  
🔹 **Highlights:**
- Accessible directly from any browser  
- Easy to edit and update (no Word or PDF needed)  
- Exportable to PDF (if built with Quarto)

---

## 🚀 Live Preview

👉 [View CV Online](https://joniec2.github.io/)  
📄 [Download PDF](#cv.pdf)
